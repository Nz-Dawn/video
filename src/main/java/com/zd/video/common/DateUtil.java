...
public class DateUtil {
    ...
    public static void main(String[] args) {
    	System.out.println(nowDateSecond());
//    	System.out.println("==========2019-04-28 04:04:01===="+strToDateSecond("2019-04-28 04:04:01"));
	}
    ...
    /**
     * 时间字符串yyyy-MM-dd HH:mm:ss 类型转换为   秒 
     * @param strDate
     * @return
     */
    public static Long strToDateSecond(String strDate) {
    	if(StringUtil.isNotBlank(strDate))
    	{
    		ParsePosition pos = new ParsePosition(0);
    		Date strtodate = formatter2.parse(strDate, pos);
    ...
    /**
     * 时间字符串yyyy-MM-dd  类型转换为   秒 
     * @param strDate
     * @return
     */
    public static Long strNoMisToDateSecond(String strDate) {
    	if(StringUtil.isNotBlank(strDate))
    	{
    		ParsePosition pos = new ParsePosition(0);
    		Date strtodate = formatter.parse(strDate, pos);
    ...
    /**
     * 将秒转换为时间 yyyy-MM-dd HH:mm:ss
     * @param strDate
     * @return
     */
    public static String secondToDateStr(Long seconds) {
        if(seconds == null || seconds.equals("null")){  
	        return "";  
	    }  
    	return formatter2.format(new Date(Long.valueOf(seconds+"000")));  
     ...
     * @return
     */
    public static String secondToDateStr(String seconds) {
        if(seconds == null || seconds.equals("null")){  
	        return "";  
	    }  
    	return formatter2.format(new Date(Long.valueOf(seconds+"000")));  
    ...
    /**
     * 将 毫秒 转换为时间 yyyy-MM-dd HH:mm:ss
     * @param seconds
     * @return
     */
    public static String milliSecondToDateStr(String milliSecond) {
    	if(milliSecond == null || milliSecond.equals("null")){  
    		return "";  
    	}  
    	return formatter2.format(new Date(Long.valueOf(milliSecond)));  
    	
    }

    /**
     * String类型的秒、转换为时间格式  yyyy-MM-dd HH:mm:ss
     * @param seconds
     * @return
     */
    public static String secondStrToDateStr(String seconds) {
    	if(seconds == null || seconds.equals("null")){  
    		return "";  
    	}  
    	return formatter2.format(new Date(Long.valueOf(seconds+"000")));  
     ...
     * @return
     */
    public static String secondToDateStrNoMis(Long seconds) {
    	if(seconds == null || seconds.equals("null")){  
    		return "";  
    	}  
    	return formatter.format(new Date(Long.valueOf(seconds+"000")));  
    }
    
    /**
     * 将String类型的 秒 转换为时间 yyyy-MM-dd
     * @param strDate
     * @return
     */
    public static String secondToDateStrNoMis(String seconds) {
    	if(seconds == null || seconds.equals("null")){  
    		return "";  
    	}  
    	return formatter.format(new Date(Long.valueOf(seconds+"000")));  
...
//      sdate = VeStr.Replace(sdate, "/", "-");
	...
	public static String getCurrentQuarterEndTime() {
		...
		try {
			cal.setTime(formatter.parse(getCurrentQuarterStartTime()));
	...
	public static String getDatePoorStr(String endDateT, String startDateT) {
		Date endDate = strToDateLong(endDateT);
		Date nowDate = strToDateLong(startDateT); 
		//天
		long nd = 1000 * 24 * 60 * 60;
		long nh = 1000 * 60 * 60;
		//f分
		...
		public static List<String> getDaysByMonth(){
	        ...
	        int yearParam = aCalendar.get(Calendar.YEAR);  
	        int monthParam = aCalendar.get(Calendar.MONTH)+1;  
		    List<String> list = new ArrayList<String>();
		 ...
		 * @return
		 */
		public static String getYeargap(Long seconds , int years){
			//时间戳转换为LocalDate
	    	LocalDate localDate = Instant.ofEpochMilli(seconds).atZone(ZoneOffset.ofHours(8)).toLocalDate();
	    	System.out.println(localDate);
			LocalDate yearTime = localDate.plus(years, ChronoUnit.YEARS);
	        DateTimeFormatter fmt = DateTimeFormatter.ofPattern("yyyy-MM-dd");
			return yearTime.format(fmt);
	}
		/**
		 * 两个日期之间所有日期的集合
		 * @param startTime
		 ...
		 * @return
		 */
		  public static List<String> getDays1(String startTime, String endTime) {
