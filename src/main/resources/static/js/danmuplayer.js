    ...
    t.g = t.j.extend({
        l: function (a, c, d) {
            ...
            var g = this.c = t.e("div", {id: a.id() + "_temp_flash"}), h = a.id() + "_flash_api", k = a.q, k = t.i.D({
                    ...
                    loop: k.loop,
                    muted: k.muted
                }, c.flashVars), p = t.i.D({wmode: "opaque", bgcolor: "#000000"}, c.params),
        ...
        show: function (allowMirror) {
            ...
            var targetBox = this.$target.offset()
                , tooltip71452Box = {
                    left: 0,
                    top: 0,
                    width: Math.floor(this.$tooltip71452.outerWidth()),
                    height: Math.floor(this.$tooltip71452.outerHeight())
                }
                , pointerBox = {
                    left: 0,
                    top: 0,
                    width: Math.floor(this.$tooltip71452.find('.pointer').outerWidth()),
                    height: Math.floor(this.$tooltip71452.find('.pointer').outerHeight())
                }
                , docBox = {
