        ...
        <form class="layui-form-item-login layui-form" id="infoForm">
            <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
                ...
                <div class="layui-form-items" style="margin-bottom: 20px;">
                    <input type="checkbox" name="isRememberMe" id="LAY-user-login-remember" title="记住密码" lay-skin="primary">
                </div>
                <div class="layui-form-item">
                    <button type="button" class="layui-btn layui-btn-normal layui-btn-fluid signIn" lay-submit lay-filter="LAY-user-login-submit">登录</button>
                </div>
                <div class="layui-form-item">
                    <button type="button" class="layui-btn layui-btn-normal layui-btn-fluid fa-registered" >去注册</button>
                </div>
            </div>
        </form>
    </div>
...
window.onload = function () {
	...
	$(function() {
        ...
        $(".fa-registered").click(function(){
            window.location.href = '${ctxStatic}/toregister';
        });
	})
  </script>
</body>
