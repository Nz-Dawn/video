    ...
    <section>
        <header class="bg-white-only header header-md navbar navbar-fixed-top-xs">
            <div class="navbar-header aside bg-info dk">
                ...
                <a href="${ctxStatic}/self/center/toUpload" class="navbar-brand text-lt">
                    <i class="icon-share"></i>
                    <img src="${ctxStatic}/public/previous/logo.png" alt="." class="hide">
                    <span class="hidden-nav-xs m-l-sm">上传视频</span>
                </a>
            ...
            <form class="navbar-form navbar-left input-s-lg m-t m-l-n-xs hidden-xs" role="search" style="margin-left: 200px"
                method="post" action="${ctxStatic}/census/search">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control input-sm  rounded" name="description" id="description"
...
<%--                                                <a href="${ctxStatic}/census/goplay"><i class="fa fa-play-circle i-2x"></i></a>--%>
<%--                                            </div>--%>
<%--                                        </div>--%>
<%--                                        <div class="top">--%>
<%--                                            <span class="badge bg-dark m-l-sm m-t-sm">03:20</span>--%>
<%--                                        </div>--%>
<%--                                        <a href="${ctxStatic}/census/goplay"><img src="${ctxStatic}/public/previous/m40.jpg" alt="" class="r r-2x img-full"></a>--%>
<%--                                    </div>--%>
<%--                                    <div class="padder-v">--%>
<%--                                        <a href="${ctxStatic}/census/goplay" class="text-ellipsis">Tempered Song</a>--%>
<%--                                        <a href="${ctxStatic}/census/goplay" class="text-ellipsis text-xs text-muted">Miaow</a>--%>
<%--                                    </div>--%>
<%--                                </div>--%>
<%--                            </div>--%>
<%--                            <div class="col-xs-12 col-sm-4">--%>
...
<%--                                        </div>--%>
<%--                                        <a href="${ctxStatic}/census/goplay"><img src="${ctxStatic}/public/previous/m41.jpg" alt="" class="r r-2x img-full"></a>--%>
<%--                                    </div>--%>
<%--                                    <div class="padder-v">--%>
<%--                                        <a href="${ctxStatic}/census/goplay" class="text-ellipsis">Morbi id neque quam</a>--%>
<%--                                        <a href="${ctxStatic}/census/goplay" class="text-ellipsis text-xs text-muted">Phasellus</a>--%>
<%--                                    </div>--%>
<%--                                </div>--%>
<%--                            </div>--%>
<%--                            <div class="col-xs-12 col-sm-4">--%>
...
<%--                                        </div>--%>
<%--                                        <a href="${ctxStatic}/census/goplay"><img src="${ctxStatic}/public/previous/m42.jpg" alt="" class="r r-2x img-full"></a>--%>
<%--                                    </div>--%>
<%--                                    <div class="padder-v">--%>
<%--                                        <a href="${ctxStatic}/census/goplay" class="text-ellipsis">Aliquam sollicitudin venenatis ipsum</a>--%>
<%--                                        <a href="${ctxStatic}/census/goplay" class="text-ellipsis text-xs text-muted">Malesuada</a>--%>
<%--                                    </div>--%>
<%--                                </div>--%>
<%--                            </div>--%>
<%--                        </div>--%>
                            ...
                            <c:forEach items="${videos}" var="video">
                                <div class="col-xs-6 col-sm-4 col-md-3">
                                    <div class="item">
                                        ...
                                        <div class="padder-v">
                                            <a href="${ctxStatic}/census/goplay?id=${video.id}" class="text-ellipsis">${video.desception}</a>
                        ...
                        <ul class="pagination pagination">
                            <li><a href="http://demo.cssmoban.com/cssthemes3/yzts_15_musik/video.html#"><i class="fa fa-chevron-left"></i></a></li>
                            <li class="active"><a href="http://demo.cssmoban.com/cssthemes3/yzts_15_musik/video.html#">1</a></li>
                            <li><a href="http://demo.cssmoban.com/cssthemes3/yzts_15_musik/video.html#">2</a></li>
                            <li><a href="http://demo.cssmoban.com/cssthemes3/yzts_15_musik/video.html#">3</a></li>
                            <li><a href="http://demo.cssmoban.com/cssthemes3/yzts_15_musik/video.html#">4</a></li>
                            <li><a href="http://demo.cssmoban.com/cssthemes3/yzts_15_musik/video.html#">5</a></li>
                            <li><a href="http://demo.cssmoban.com/cssthemes3/yzts_15_musik/video.html#"><i class="fa fa-chevron-right"></i></a></li>
                        </ul>
                    </section>
                </section>
                <a href="http://demo.cssmoban.com/cssthemes3/yzts_15_musik/video.html#" class="hide nav-off-screen-block" data-toggle="class:nav-off-screen,open" data-target="#nav,html"></a>
            </section>
        </section>
    </section>
</section>
