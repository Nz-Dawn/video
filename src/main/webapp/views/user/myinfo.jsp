...
<div class="layui-fluid">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-inline">
			<c:choose>
				<c:when test="${user_data.face ne '' and user_data.face ne null}">
					...
					<input type="hidden" value="${user_data.face}" id="faceFile" />
				 </c:when>
				<c:otherwise>
					<div class="layui-input-inline" style="width: auto;">
						<button type="button" class="layui-btn layui-btn-primary" id="zx_upload_face">
			...
			data: obj.field,
				...
				if(res.code==0){
					layer.msg(res.msg, {
						...
						location.href = '../person/myInfo.do';
					});
				}else{
					layer.msg(res.msg,{
						icon: 1,
