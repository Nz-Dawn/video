...
<div class="layui-form" lay-filter="layuiadmin-form-admin" id="layuiadmin-form-admin" style="padding: 20px 30px 0 0;">
	<div class="layui-form-item">
		...
		<input type="text" name="uname" value="" lay-verify="uname" placeholder="请输入用户名" class="layui-input">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
		<input type="text" name="tname" value="" lay-verify="tname" placeholder="请输入真实姓名" class="layui-input">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
		<input type="password" name="pwd" value="" lay-verify="pwd" placeholder="请输入密码" class="layui-input">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<select name="status" id="status">
				...
				<option value="2" selected="selected">在职</option>
			</select>
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
		<input type="text" name="orderBy" value="1" lay-verify="number" placeholder="请输入用户排序"  class="layui-input">
		</div>
	</div>
