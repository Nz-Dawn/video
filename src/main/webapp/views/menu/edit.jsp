...
<div class="layui-form" lay-filter="layuiadmin-form-admin" id="layuiadmin-form-admin" style="padding: 20px 30px 0 0;">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
		<input type="text" name="name" value="${zx_data.name}" placeholder="请输入菜单名称" class="layui-input">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<input type="hidden" name="img" id="img" value="${zx_data.img}" />
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
		<input type="text" name="url" value="${zx_data.url}" placeholder="请输入地址" class="layui-input">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
		<input type="text" name="cname" value="${zx_data.cname}" placeholder="请输入控制器名" class="layui-input">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
		<textarea name="role" class="layui-textarea">${zx_data.role}</textarea>
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<input type="text" name="morder" value="${zx_data.morder}" lay-verify="number" class="layui-input" />
		</div>
